...
진행 중 phase 없음 (Phase 11 종료 직후). 다음 phase 진입 시 본 § 갱신.

## Completed Phases

Phase 1~11 + v0.4.1 / v0.4.2 누적 history — 자세한 내용은 git log + CHANGELOG.md 참조. 핵심 마일스톤:
...
- Phase 11 (2026-05-13) — GitHub Release distribution 인프라 (spec-release-distribution.md + .github/workflows/release.yml + README install 섹션). Release notes 작성 = 다음 release phase 책임.
