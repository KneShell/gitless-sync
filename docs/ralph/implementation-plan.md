...
## Status
- Last updated: 2026-05-10 (Phase 7.1 task G 완료 — `tests/scan_trees_fallback.rs` integration fixture: truncated→fallback 4-blob multi-layer descent → ScanReport summary + forward-slash depth-2 path 검증)
- Total tasks: 86
- Completed: 67 / 86
